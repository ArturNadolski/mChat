...
$lang = array_merge($lang, [
	...
	'MCHAT_FLOOD_TIME_EXPLAIN'						=> 'Permet de saisir la durée en secondes après laquelle il est possible d’envoyer un nouveau message dans le mini-tchat.<br><em>Valeurs acceptées : 0 à 3600 secondes (1 heure). Définir sur 0 pour désactiver ce comportement.</em>',
	'MCHAT_FLOOD_MESSAGES'							=> 'Flood de messages',
	'MCHAT_FLOOD_MESSAGES_EXPLAIN'					=> 'Permet de saisir le nombre de messages consécutifs qu’un membre peut publier avant qu’un autre membre publie dans le mini-tchat.<br><em>Les valeurs autorisées sont comprises entre 0 et 100 messages. Par défaut définie sur 0, cette valeur désactive la limite du flood.</em>',
	...
	'TOO_LARGE_MCHAT_FLOOD_MESSAGES'				=> 'La valeur saisie pour le flood de messages est trop grande.',
